...
{
    public abstract class MomoCollectionServiceBase
    {
        private readonly MomoSettings _settings;
        private readonly IRestClient _restClient;
        private readonly IRestClient _tokenClient;
        private readonly IMemoryCache _memoryCache;
        private const string TokenCacheKey = "Momo.Collection.Token";

        public MomoCollectionServiceBase(IRestClient restClient, IRestClient tokenClient, 
            IOptions<MomoSettings> settings, IMemoryCache memoryCache)
        {
            ...
            string authorization = Convert.ToBase64String(Encoding.UTF8.GetBytes($"{_settings.Collection.OAuth2.ClientId}:{_settings.Collection.OAuth2.ClientSecret}"));
            ...
            _restClient.Client.DefaultRequestHeaders.Add("X-Target-Environment", _settings.Collection.OAuth2.XTargetEnvironment);
            _restClient.Client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", _settings.Collection.OAuth2.OcpApimSubscriptionKey);
        }
        ...
        private async Task<string> GetToken()
        {
            ...
            var token = await _memoryCache.GetOrCreateAsync(
                ...
                async cacheEntry =>
                {
                    ...
                    var responseData = JsonSerializer.Deserialize<CollectionOAuth2TokenResponseModel>(responseJson);
